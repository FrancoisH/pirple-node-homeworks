...
workers.performCheck = function (originalCheckData) {
  ...
  var req = _moduleToUse.request(requestDetails, function (res) {
    ...
    // Grab the status of the send request & update the check outcome and pass the data along
...
// Special logic for accommodating a check that has never been tested before (don't alert on it)
